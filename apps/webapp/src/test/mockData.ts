...
const initialFacilityNodesResponse: FacilityNodesResponse = {
  ...
  nodes: [
    {
      id: 'ahu-01', label: 'AHU 01', type: 'ahu', status: 'warning',
      position: 0.92, parentIds: [], fault: null,
    },
    {
      id: 'ahu-02', label: 'AHU 02', type: 'ahu', status: 'warning',
      position: 0.55, parentIds: [], fault: null,
    },
    {
      id: 'BEL-ACT-001', label: 'Kitchen Supply Actuator', type: 'actuator', status: 'healthy',
      position: 0.95, parentIds: ['ahu-01'], fault: null,
    },
    {
      id: 'BEL-DMP-002', label: 'Kitchen Exhaust Damper', type: 'damper', status: 'healthy',
      position: 0, parentIds: ['ahu-01'], fault: null,
    },
    {
      id: 'BEL-VLV-003', label: 'Living Room Chiller Valve', type: 'valve', status: 'critical',
      position: 0.12, parentIds: ['ahu-01'],
      fault: {
    ...
    {
      id: 'BEL-ACT-004', label: 'Living Room Damper Actuator', type: 'actuator', status: 'warning',
      position: 0.88, parentIds: ['ahu-01'],
      fault: {
    ...
    {
      id: 'BEL-VLV-005', label: 'Bathroom Water Valve', type: 'valve', status: 'warning',
      position: 0, parentIds: ['ahu-02'],
      fault: {
    ...
    {
      id: 'BEL-DMP-006', label: 'Bedroom 1 Supply Damper', type: 'damper', status: 'healthy',
      position: 1.0, parentIds: ['ahu-02'], fault: null,
    },
    {
      id: 'BEL-ACT-007', label: 'Bedroom 1 Return Actuator', type: 'actuator', status: 'healthy',
      position: 0.08, parentIds: ['ahu-02'], fault: null,
    },
    {
      id: 'BEL-DMP-008', label: 'Bedroom 2 Fresh Air Damper', type: 'damper', status: 'healthy',
      position: 0.42, parentIds: ['ahu-02'], fault: null,
    },
  ],
};
