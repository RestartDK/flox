...
def build_datacenter_bayesian_graph() -> BayesianGraph:
    nodes = [
        BayesianNode(
            id="f_act_intake",
            label="Intake actuator failure",
            layer="components",
            kind="component_failure",
        ),
        BayesianNode(
            id="f_vlv_ab",
            label="Supply valve AB failure",
            layer="components",
            kind="component_failure",
        ),
        BayesianNode(
            id="f_vlv_cd",
            label="Supply valve CD failure",
            layer="components",
            kind="component_failure",
        ),
        BayesianNode(
            id="f_act_ef_supply",
            label="Supply actuator EF failure",
            layer="components",
            kind="component_failure",
        ),
        BayesianNode(
            id="f_dmp_ab",
            label="Exhaust damper AB failure",
            layer="components",
            kind="component_failure",
        ),
        BayesianNode(
            id="f_act_cd_exhaust",
            label="Exhaust actuator CD failure",
            layer="components",
            kind="component_failure",
        ),
        BayesianNode(
            id="f_dmp_ef",
            label="Exhaust damper EF failure",
            layer="components",
            kind="component_failure",
        ),
        BayesianNode(
            id="f_dmp_outlet",
            label="Main outlet damper failure",
            layer="components",
            kind="component_failure",
        ),
        BayesianNode(
